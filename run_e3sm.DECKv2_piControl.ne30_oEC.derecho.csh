...
set job_name       = DECKv2_piControl
set compset        = A_WCYCL1850S_CMIP6
set resolution     = ne30_oECv3_ICG
##jtset machine        = cori-knl
set machine        = derecho
set walltime       = 00:30
setenv project       P93300642

### SOURCE CODE OPTIONS
set fetch_code     = false        # flag to toggle cloning source code
set e3sm_tag       = maint-2.1   # github tag or hash
set tag_name       = E3SM.021524 # code sub-directory name

### CASE_NAME
set case_name = ${tag_name}.${job_name}.ne30_oEC.derecho
...
set processor_config = customderecho # PE count: (1 nodes)
...
### DIRECTORIES
set code_root_dir               = /glade/work/jet
##jtset e3sm_simulations_dir        = /global/cscratch1/sd/$USER/E3SM_simulations
set e3sm_simulations_dir        = /glade/derecho/scratch/$USER/E3SM_simulations
...
else if ( `lowercase $processor_config` == 'customderecho' ) then

  e3sm_print 'using custom layout for derecho because $processor_config = '$processor_config

  ${xmlchange_exe} MAX_TASKS_PER_NODE="128"
  ${xmlchange_exe} PES_PER_NODE="128"

  ${xmlchange_exe} NTASKS_ATM="128"
  ${xmlchange_exe} ROOTPE_ATM="0"

  ${xmlchange_exe} NTASKS_LND="128"
  ${xmlchange_exe} ROOTPE_LND="0"

  ${xmlchange_exe} NTASKS_ICE="128"
  ${xmlchange_exe} ROOTPE_ICE="0"

  ${xmlchange_exe} NTASKS_OCN="128"
  ${xmlchange_exe} ROOTPE_OCN="0"

  ${xmlchange_exe} NTASKS_CPL="128"
  ${xmlchange_exe} ROOTPE_CPL="0"

  ${xmlchange_exe} NTASKS_GLC="128"
  ${xmlchange_exe} ROOTPE_GLC="0"

  ${xmlchange_exe} NTASKS_ROF="128"
  ${xmlchange_exe} ROOTPE_ROF="0"

  ${xmlchange_exe} NTASKS_WAV="128"
  ${xmlchange_exe} ROOTPE_WAV="0"
