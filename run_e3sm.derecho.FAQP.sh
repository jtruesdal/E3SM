...
readonly PROJECT="P93300642"

# Simulation
readonly COMPSET="FAQP"
#readonly RESOLUTION="ne30pg2_EC30to60E2r2"
readonly RESOLUTION="ne4_ne4"
# BEFORE RUNNING : CHANGE the following CASE_NAME to desired value
readonly CASE_NAME="FAQP.derecho.ne4_ne4.03"
# If this is part of a simulation campaign, ask your group lead about using a case_group label
# readonly CASE_GROUP=""

# Code and compilation
readonly CHECKOUT="20240108"
readonly BRANCH="maint-2.1"
readonly CHERRY=( )
...
# Set paths
readonly CODE_ROOT="/glade/work/jet/E3SM/collections/E3SM-NCAR-maint-2.1"
readonly CASE_ROOT="/glade/work/jet/E3SM/cases"
readonly CASE_ROOTEXE="/glade/derecho/scratch/$USER/E3SMv2/${CASE_NAME}"

readonly PIO_LIBDIR=$PIO/lib
readonly PIO_INCDIR=$PIO/include

# Sub-directories
readonly CASE_BUILD_DIR=${CASE_ROOTEXE}/build
readonly CASE_ARCHIVE_DIR=${CASE_ROOTEXE}/archive
...
if [ "${run}" != "production" ]; then
  ...
  readonly CASE_SCRIPTS_DIR=${CASE_ROOTEXE}/tests/${run}/case_scripts
  readonly CASE_RUN_DIR=${CASE_ROOTEXE}/tests/${run}/run
  ...
  readonly CASE_SCRIPTS_DIR=${CASE_ROOTEXE}/case_scripts
  readonly CASE_RUN_DIR=${CASE_ROOTEXE}/run
  readonly PELAYOUT="L"
...
case_setup() {
    ...
    if [ `./xmlquery --value COMP_ATM` == "datm"  ]; then
      ...
      echo $'\nCOSP simulator will not be used\n'
